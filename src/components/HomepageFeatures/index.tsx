...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Our focus is on learning you to make a great  User Experience by learning you to analyze the 
      needs of your users and how to make it easy for them to use your application.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
      You either have a lot of time or you don't. If you don't, you need to make sure that you are not wasting time on things that are not important.
